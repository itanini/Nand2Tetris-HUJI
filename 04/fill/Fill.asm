...
@KBD 
D=M 
// if keyboard is pressed (not 0) loop1 = blacken the screen
@LOOP1 
D;JNE 

//if screen is white if so we check the key board again
@SCREEN
D=M
@LOOP
D;JEQ 
...
//a loop that blacken all the bits
(LOOP1)
@SCREEN 
D=A 
@i 
